...
class occupancy_performance_report1(osv.osv):
    _name = "occupancy.performance.report1"
    _auto = False
    ...
    def init(self, cr):
        ...
        obj = cr.execute("""CREATE or REPLACE VIEW occupancy_performance_report1 as SELECT id,name,type_id,occupancy_rates,purchase_date
