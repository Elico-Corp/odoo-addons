...
class safety_certificate_report(orm.TransientModel):
    ...
    def open_certificate_expiry_tree(self, cr, uid, ids, context=None):
        ...
        wiz_form_id = ir_model_data_obj.get_object_reference(cr,uid,'property_management', 'property_certificate_view_tree')[1]
    ...
    def print_report(self, cr, uid, ids, data, context=None):
            ...
            return {
                    ...
                    'report_name': 'safety.certificate.expiry',
                    'datas': datas,
                }
