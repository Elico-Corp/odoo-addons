 ...
 * have basic modules installed (report_xls, mrp_production_workcenter_line_reporting)
...
`here <https://github.com/Elico-Corp/odoo/issues/new?body=module:%20mrp_production_workcenter_line_reporting_excel%0Aversion:%20{8.0}%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
