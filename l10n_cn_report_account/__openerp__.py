...
{
    'name': 'Chinese-English Invoices/中英文发票',
    'version': '1.0',
    'category': 'Finance',
    'description': """
...
2. create an entry in Administration/Reporting/Reporting Header called 'external portrait' 
...
Check file l10n_cn_report_header_example.xml for header example you can copy directly
    ...
    'complexity': "normal",
    'depends': ['account','base_report_header'],
    'init_xml': [],
    'update_xml': [
        'l10n_cn_report_account_view.xml',
	],
    'demo_xml': [], 
    'test': [],
    'installable': True,
