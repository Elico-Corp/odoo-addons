...
openerp.web_pdf_preview = function(instance) {
    ...
    var trigger_download = function(self, response, c) {
        ...
        //window.open('/report/preview?data=' + encodeURIComponent(JSON.stringify(response)) + '&token=' + new Date().getTime() + '&session_id=' + self.session.session_id, 'report', '');
        //window.open(url, 'report', '');

        var iframe1 = document.getElementById("reoprt_print");
        if (iframe1 == null){
           iframe1 = document.createElement("IFRAME");
           iframe1.setAttribute("id","reoprt_print")
