...

{
    ...
    'author': 'Elico Corp',
    'website': '',
    'depends': ['document', 'elico_crm_configuration_purchasing'],
    'init_xml': ['document_data.xml'],
    'update_xml': ['document_view.xml', 'security/ir.model.access.csv','elico_document_ics_purchasing_config_wizard.xml'],
