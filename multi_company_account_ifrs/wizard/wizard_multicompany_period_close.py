...
def _data_save(self, cr, uid, data, context):
    ...
    if not data['form']['sure']:
        raise wizard.except_wizard('UserError', 'Process canceled, please check the box !')
...
class wizard_multicompany_period_close(wizard.interface):
    states = {
    	'init': {
    		'actions': [_data_load],
...
wizard_multicompany_period_close('multi_company_account_ifrs.multicompany.period.close')
