...
class wizard_multicompany_fiscalyear_close(wizard.interface):
    states = {
        'init': {
            'actions': [_data_load],
...
wizard_multicompany_fiscalyear_close('multi_company_account_ifrs.multicompany.fiscalyear.close')
