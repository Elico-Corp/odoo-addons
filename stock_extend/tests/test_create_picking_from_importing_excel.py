...
class ImportExcelPrepareValueTestCase(TransactionCase):
    def setUp(self):
        ...
        # file 1
        self.picking_importer = \
            excel_importer.incoming_shipment_excel_importer(
                file_path='incoming_shipment.xlsx')
        # file 2
        self.picking_importer2 = \
            excel_importer.incoming_shipment_excel_importer(
    ...
    def test02_prepare_value_after_convert(self):
        ...
        self.assertEqual(u'01-22321',
                         val['move_lines'][0][2]['supplier_seiral_no'])
        self.assertEqual('01-22323',
                         val['move_lines'][2][2]['supplier_seiral_no'])
        self.assertEqual('01-22324',
                         val['move_lines'][3][2]['supplier_seiral_no'])
        self.assertEqual(u'8G-001',
                         val['move_lines'][12][2]['supplier_seiral_no'])
    ...
    def test02_prepare_value_from_file2_after_convert(self):
        ...
        self.assertEqual(u'201-22322',
                         val['move_lines'][1][2]['supplier_seiral_no'])
...
class CreatePickingFromImportExcelTestCase(TransactionCase):
    def test_01_prepare_odoo_value_from_excel_value(self):
        ...
        val = self.env['incoming.shipment.converter']\
            .convert_odoo_value_from_value(val)
        ...
        self.assertEqual(u'201-22322',
                         val['move_lines'][1][2]['supplier_seiral_no'])
        self.assertEqual('201-22324',
                         val['move_lines'][3][2]['supplier_seiral_no'])
        self.assertEqual('101-22325',
                         val['move_lines'][4][2]['supplier_seiral_no'])
        self.assertEqual('201-22326',
                         val['move_lines'][5][2]['supplier_seiral_no'])
        # uom_id
    ...
    def test02_create_picking_from_excel(self):
        ...
        odoo_val = self.env['incoming.shipment.converter']\
            .convert_odoo_value_from_value(excel_val)
    ...
    def get_fake_value_for_test2(self):
        val = {
            ...
            'move_lines': [
                ...
                (0, 0, {'product_id': 3, 'product_uom_qty': 3,
                        'product_uom': 1, 'location_id': 8,
                        'location_dest_id': 12, 'name': 'import fake 2',
                        }
                 )
            ],
        }
    ...
    def test04_create_picking_from_file_path(self):
        ...
        self.assertEqual(
            inchoming_type_id.default_location_src_id.id,
            packs[1].location_id.id)
        self.assertEqual(
            inchoming_type_id.default_location_dest_id.id,
            packs[12].location_dest_id.id)
