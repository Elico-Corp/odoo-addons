...
##############################################################################
#
#    Author: Yannick Vaucher, Guewen Baconnier / Eric Caudal
...
class AccountAccountLine(osv.osv):
    ...
    _columns = {'gl_foreign_balance': fields.float('Aggregated Amount curency', digits_compute=dp.get_precision('Account')),
                'gl_balance': fields.float('Aggregated Amount', digits_compute=dp.get_precision('Account')),
                'gl_revaluated_balance': fields.float('Revalued Amount', digits_compute=dp.get_precision('Account')),
...
class account_move(osv.osv):
    ...
    _columns = {'to_be_reversed': fields.boolean('Account moves to be reversed')
    }
...
class AccountAccount(osv.osv):
    ...
    def _revaluation_query(self,
        ...
        logger.debug('_revaluation_query.query: %s'%(query,))
        logger.debug('_revaluation_query.params: %s'%(params,))
