...
class packing(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(packing, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.l10n.cn.packing', 'stock.picking', 'addons/l10n_cn_report_stock/report/packing.rml', parser=packing, header="external landscape")
