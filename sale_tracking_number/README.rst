...
===================
Sale tracking number
===================

This module extends the functionality of Sale to support add tracking number in sale order.
...
`here <https://github.com/Elico-Corp/odoo/issues/new?body=module:%20sale_tracking_number%0Aversion:%20{8.0}%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
