...

{
    ...
    'category':     'Tools',
    'complexity':   "easy",
    'description':  """This module generate a full gap-analysis in .ods with the cost estimation.
...
""",
    ...
    'depends':      ['gap_analysis_project_long_term','report_aeroo','project_timesheet'],
    'init_xml':     [],
    # 'update_xml':   [
