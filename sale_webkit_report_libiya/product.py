...
class product(osv.osv):
    ...
    _columns = {
        'purchase_currency_id': fields.many2one('res.currency', 'Currency', required=True),
    }
...
class sale_order_line(osv.osv):
    ...
    # _columns = {
    #     'purchase_currency_id': fields.related(
    #         'product.product', 'purchase_currency_id', store=True),
    # }
    ...
    def product_id_change(self, cr, uid, ids, pricelist, product, qty=0,
        ...
        if not pricelist:
            ...
            pricelist_data_obj = self.pool.get('product.pricelist').browse(cr, uid, [pricelist], context=context)[0]
            ...
            original_price = self.pool.get('product.pricelist').price_get(cr, uid, [pricelist],
            ...
            if not pricelist_data_obj.use_purchase_currency:
                ...
                if purchase_curr :
                    amount = currency_obj.compute(
                        cr,uid, purchase_curr,currency_id_list, original_price,context=context)
                else:
                    amount = currency_obj.compute(
                        cr,uid, company_curr,currency_id_list, original_price,context=context)
