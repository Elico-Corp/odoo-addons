...
class multicompany_report(osv.osv_memory):
    """
	...
	if data['form']['compared']:
            return {
                ...
                'report_name': 'elico_multi_company_financial_statements.multicompany_compared_report',
                'datas': data,
            }
        else:
            return {
                'type': 'ir.actions.report.xml',
                'report_name': 'elico_multi_company_financial_statements.multicompany_report',
                'datas': data,
            }
