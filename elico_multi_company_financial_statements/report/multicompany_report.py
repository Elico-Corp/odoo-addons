...
class multicompany_report(report_sxw.rml_parse):
	def __init__(self, cr, uid, name, context):
		super(multicompany_report, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.elico_multi_company_financial_statements.multicompany_report', 
	'account.account', 
	'addons/elico_multi_company_financial_statements/report/multicompany_report.rml', 
	parser=multicompany_report, 
	header=False)
