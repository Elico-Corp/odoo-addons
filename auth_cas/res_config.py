...
via CAS')
    ...
    def set_cas_values(self):
        ...
        if self.cas_server or self.cas_server_port:
            ...
            if self.cas_server and self.cas_server_port:
                if self.cas_activated:
                    icp.set_param('auth_cas.cas_activated',
                                  str(self.cas_activated))
                    # There is no error
                    error = False
                icp.set_param('auth_cas.cas_server', self.cas_server)
                icp.set_param('auth_cas.cas_server_port',
        ...
        icp.set_param('auth_cas.cas_create_user', str(self.cas_create_user))
...
error in the configuration.'
        ...
        try:
            ...
            res = login(cas_server, 'casuser', 'Mellon')
            if res[0] == 5:
